...
/**
 * The version of Main using in-memory user data access for testing without an external database.
 */
public class MainWithInMemory {

    /**
     * The main method for starting the program with in-memory storage.
